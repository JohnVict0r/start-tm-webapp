export default {
  ...
  'form.submit': 'Submit',
  'form.save': 'Save',
  'form.user-name.placeholder': 'How would you like to be called?',
  ...
  'menu.teams': 'Teams',
  'menu.teams.my-teams': 'My Teams',
  'menu.teams.team': 'Team',
  'menu.teams.team.projects': 'Projects of Teams',
  'menu.teams.team.workflows': 'Workflows of Teams',
  'menu.teams.team.members': 'Members of Team',
  'menu.projects': 'Projects',
  'menu.projects.my-projects': 'My Projects',
  'menu.projects.project': 'Project',
  'menu.projects.new-project': 'New Project',
  'menu.workflows': 'Workflows',
  'menu.workflows.workflows-list': 'My Workflows',
  'menu.workflows.new-workflow': 'New Workflow',
