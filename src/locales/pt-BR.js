export default {
  ...
  'app.login.backlogin': 'Voltar ao Login',
  'app.register.register': 'Cadastro',
  'app.register.mailsend': 'Um email foi eviado para {email} com o link de recuperação',
  'app.register.get-verification-code': 'Recuperar código',
  'app.register.mailrecover': 'Recuperar senha',
  'app.register.send': 'Enviar',
  ...
  'app.settings.basic.name': 'Nome',
  'app.settings.basic.current-password': 'Senha Atual',
  'app.settings.basic.newpassword': 'Nova Senha',
  'app.settings.basic.name-message': 'Por favor insira seu nome',
  'app.settings.basic.name-placeholder': 'Como gostaria de ser chamado?',
  ...
  'app.admin.workflows.name-placeholder': 'Nome',
  'app.admin.workflows.description': 'Descrição',
  'app.admin.workflows.description-placeholder': 'Descrição',
  'app.admin.workflows.create': 'Criar',
  'app.form.workflows.success': 'Fluxo de trabalho criado com sucesso',
  'app.team.suregetout': 'Tem certeza que quer sair da equipe?',
  'app.team.newteam': 'Nova equipe',
  'app.team.teamname': 'Nome da equipe',
  'app.team.teamdescription': 'Descricao da equipe',
  'app.team.editteam': 'Editar equipe',
  'app.team.teamname.required': 'Por favor informe o nome da equipe!',
  'app.team.teamname.helper': 'Insita o nome da equipe',
  'app.team.teamdescription.required': 'Por favor informe a descricao da equipe!',
