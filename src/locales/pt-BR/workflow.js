export default {
  'app.workflow.form.node.name': 'Nome',
  'app.workflow.form.node.name-message': 'Por favor insira um nome!',
  'app.workflow.form.node.status': 'Status Associado',
  'app.workflow.form.node.status-message': 'Por favor escolha um status!',
