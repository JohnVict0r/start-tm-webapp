...
class NewEvent extends PureComponent {
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title="Novo Clube">
        <Card bordered={false}>
          <Form onSubmit={this.handleSubmit} hideRequiredMark style={{ marginTop: 8 }}>
            ...
            {/* Inserir combobox para federação */}
            <Form.Item
              label="Federação"
              {...formItemLayout}
              // help={
              ...
              // }
            >
              {getFieldDecorator('federation', {
                rules: [{ required: true, message: 'Selecione uma federação!' }],
                initialValue: 'FPOTM',
              })(
                <Select placeholder="Federação">
                  <Select.Option key={1}>FPOTM</Select.Option>
                  <Select.Option key={2}>CETM</Select.Option>
                </Select>
              )}
            </Form.Item>
